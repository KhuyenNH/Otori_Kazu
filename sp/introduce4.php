...
<html lang="ja">
    ...
    <body>
        <div id="container">
            ...
            <!-- /header -->
            <div class="page-main">
                <div id="intro-04__local-01">
                    <div class="container_box">
                        <div class="post">
                            <h2 class="title_h2">労働問題</h2>
                            <div class="thumbnews"><img src="images/root/introduce/thumb_news_01_D.jpg" alt=""></div>
                        ...
                        <div class="post">
                            <h2 class="title_h2">労働問題</h2>
                            <div class="thumbnews"><img src="images/root/introduce/thumb_news_02_D.jpg" alt=""></div>
                            <div class="description">
                        ...
                        <div class="post">
                            <h2 class="title_h2">労働問題</h2>
                            <div class="thumbnews"><img src="images/root/introduce/thumb_news_03_D.jpg" alt=""></div>
                            <div class="description">
                        ...
                        <div class="post">
                            <h2 class="title_h2">労働問題</h2>
                            <div class="thumbnews"><img src="images/root/introduce/thumb_news_04_D.jpg" alt=""></div>
                            <div class="description">
