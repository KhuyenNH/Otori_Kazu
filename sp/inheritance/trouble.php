                ...
                <div id="trouble__local-01">
                    <div class="container_box">
                        ...
                        <div class="post">
                                ...
                                <ul class="list_table">
                                    ...
                                    <li>
                                        ...
                                        <div class="group_list">
                                            <div class="group_list">
                                                <p class="text">
                        						①　皇室経済法の規定により、行為とともに後嗣が受け継ぐもの<br>
                        						②　墓地や墓石、仏壇、祭具など日常礼拝の対象としているもの（投資対象を除く）<br>
                        						③　宗教、慈善、学術、その他公益を目的とする事業を行う人が取得した財産で、<br>
                                                その公益事業に使われることが確実なもの<br>
                        						④　心身障害者共済制度にもとづく給付金の受益権<br>
                        						⑤　相続人が取得した生命保険金などのうち「500万円×法定相続人の数」までの金額<br>
                        						⑥　相続人が取得した死亡退職金などのうち「500万円×法定相続人の数」までの金額<br>
                        						⑦　個人で経営している幼稚園の事業で使われていた財産で一定の要件を満たすもの<br>
                        						⑧　相続税の申告期限までに国や地方公共団体、特定の公益法人に寄与したもの、<br>
                                                あるいは特定の公益信託の信託財産とするために支出したもの
                        						</p>
                                            </div>
                                        </div>
                                    </li>
                            ...
                            <!-- /end -->
                            <div class="description">
                                <h3 class="title_qa">財産を相続したけれど、相続税が払えません。どうすればいいの？</h3>
                        ...
                        <div class="post">
                            ...
                            <div class="description">
                                <h3 class="title_qa">遺産分割が終わった後に、他の土地がでてきたのですが、協議はやり直せますか？</h3>
                            ...
                            <!-- /end -->
                            <div class="description">
                                <h3 class="title_qa">遺産分割協議が終わった後に、亡くなった父が過去に認知した子どもが現れました。どうすればいいですか？</h3>
                                <p class="answerText">相続人全員が参加しない遺産分割協議は無効ですので、分割協議をやり直す必要があります。</p>
                            </div>
                            <p class="toTop">ページTOPへ ▲</p>
                            <!-- /end -->
                            <div class="description">
                                <h3 class="title_qa">父の遺産分割が終わった後に、別の遺言書が出てきました。どうすればいいですか？</h3>
                        ...
                        <div class="post">
                            ...
                            <div class="description">
                                <h3 class="title_qa">家庭裁判所にパソコンで書かれた遺言書は無効と言われました。本当ですか？</h3>
                                <p class="answerText">遺言は全文が自筆で書かれている必要があります。一部がパソコンで書かれていても無効となり、遺言書としては認められません。</p>
                            </div>
                            <p class="toTop">ページTOPへ ▲</p>
                            <!-- /end -->
                            <div class="description">
                                <h3 class="title_qa">一度書いた遺言書を直したいのですが、できますか？</h3>
                            ...
                            <!-- /end -->
                            <div class="description">
                                <h3 class="title_qa">長兄が良い財産をもらい、私は不利な財産を残すと遺言に書かれています。納得がいかないのですが？</h3>
